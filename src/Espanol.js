      ...
      <table id="spanish">
        <tbody>
          ...
          <tr>
            ...
            <th>
              Vergangenheit, aber entweder der Zeitraum noch nicht abgeschlossen
              ist
              <br></br>
              oder gerade eben abgeschlossen wurde (+-24h). Unkonkrete Zeit
              angabe.
            </th>
          </tr>
          <tr>
            <td>
              <h4 class="explanation">
                Wir befinden uns ausserhalb des Zeitraum der beendet ist
              </h4>
          ...
          <tr>
            <td>
              <h4 class="explanation">
                Zeitraum der länger schon abgeschlossen ist - thumb rule: meher
                als 24h
              </h4>
              ...
              <table id="creating">
                <tbody>
                  ...
                  <tr>
                    <td>
                      <div class="main">
                        mir<span class="ending">é</span>
                      </div>
                    </td>
                    <td>
                      <span class="main">
                        com<span class="ending">í</span>
                      </span>
                    </td>
                    <td>
                      <span class="main">
                        fu<span class="ending">í</span>
                      </span>
                    </td>
                  </tr>
                  <tr>
                    <td>
                      <div class="main">
                        mir<span class="ending">aste</span>
                      </div>
                    </td>
                    <td>
                      <span class="main">
                        com<span class="ending">iste</span>
                      </span>
                    </td>
                    <td>
                      <span class="main">
                        fu<span class="ending">iste</span>
                      </span>
                    </td>
                  </tr>
                  <tr>
                    <td>
                      <div class="main">
                        mir<span class="ending">ó</span>
                      </div>
                    </td>
                    <td>
                      <span class="main">
                        com<span class="ending">ió</span>
                      </span>
                    </td>
                    <td>
                      <span class="main">fue</span>
                    </td>
                  </tr>
                  <tr>
                    <td>
                      <div class="main">
                        mir<span class="ending">amos</span>
                      </div>
                    </td>
                    <td>
                      <span class="main">
                        com<span class="ending">imos</span>
                      </span>
                    </td>
                    <td>
                      <span class="main">
                        fu<span class="ending">imos</span>
                      </span>
                    </td>
                  </tr>
                  <tr>
                    <td>
                      <div class="main">
                        mir<span class="ending">ásteis</span>
                      </div>
                    </td>
                    <td>
                      <span class="main">
                        com<span class="ending">isteis</span>
                      </span>
                    </td>
                    <td>
                      <span class="main">
                        fu<span class="ending">isteis</span>
                      </span>
                    </td>
                  </tr>
                  <tr>
                    <td>
                      ...
                      <div class="main">
                        mir<span class="ending">aron</span>
                      </div>
                    </td>
                    <td>
                      <span class="main">
                        com<span class="ending">ieron</span>
                      </span>
                    </td>
                    <td>
                      <span class="main">fueron</span>
                    </td>
                  </tr>
                </tbody>
              </table>
            ...
            <td>
              <table id="creating">
                <tbody>
                  ...
                  <tr>
                    <td>
                      <div class="main">he</div>
                    </td>
                    <td rowspan="6">
                      trabaj<span class="ending">ado</span>
                      <br></br>
                      est<span class="ending">ado</span> <br></br>
                      (Estado: war aber nicht mehr )
                      <br></br>
                      ...
                      <br></br>s<span class="ending">ido</span> (Sido: war und
                      könnte noch sein)
                      <br></br>
                    </td>
                  </tr>
                  <tr>
                    <td>
                      <div class="main">has</div>
                    </td>
                  </tr>
                  <tr>
                    <td>
                      <div class="main">ha / ay</div>
                    </td>
                  </tr>
                  <tr>
                    <td>
                      <div class="main">hemos</div>
                    </td>
                  </tr>
                  <tr>
                    <td>
                      <div class="main">habeis</div>
                    </td>
                  </tr>
                  <tr>
                    <td>
                      <div class="main">han</div>
                    </td>
                  </tr>
                </tbody>
              </table>
